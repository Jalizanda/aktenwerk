...
/// Heroicons-Outline-Pfade, 1:1 aus der SV-Software übernommen.
/// Jeder Eintrag ist das `d`-Attribut eines `<path>` mit
/// `stroke-linecap="round" stroke-linejoin="round"`.
class Heroicons {
  Heroicons._();

  static const Map<String, List<String>> _paths = {
    'dashboard': [
      'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6',
    ],
    'kunden': [
      'M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6 5.87v-2a4 4 0 00-4-4H9a4 4 0 00-4 4v2m8-10a3 3 0 11-6 0 3 3 0 016 0zm6 3a3 3 0 11-6 0 3 3 0 016 0z',
    ],
    'angebote': [
    ...
    'gutachten': [
      'M9 12h6m-6 4h6m-6-8h6M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z',
    ],
    'erlaeuterungen': [
      'M3 10h18M3 14h18M5 6h14a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2z',
    ],
    'rechnungen': [
      'M14.121 15.536c-.738.738-1.887.814-2.65-.052-.763-.866-.763-2.269 0-3.135.763-.866 1.912-.79 2.65-.052M9 8h6m-6 4h3m-6 9h12a2 2 0 002-2V5a2 2 0 00-2-2H6a2 2 0 00-2 2v14a2 2 0 002 2z',
    ],
    'eingangsrechnungen': [
    ...
    // Recherche-Ablage: Lesezeichen-Symbol (bookmark-outline)
    'recherche': [
    ...
    'lv': [
      // Klemmbrett-Liste mit Häkchen — passt zu LV/Ausschreibung
      'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4',
    ],
    'anschreiben': [
      'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z',
    ],
    // Serienbrief: zwei versetzte Briefumschläge (Massen-Versand-Metapher).
    'serienbrief': [
      // Hinterer Briefumschlag (oben/rechts, verkleinert)
      'M9 4h10a1 1 0 011 1v8a1 1 0 01-1 1h-2',
      'M9 6l5.5 3.67L20 6',
      // Vorderer Briefumschlag (größer, unten/links)
      'M5 9h11a1 1 0 011 1v9a1 1 0 01-1 1H5a1 1 0 01-1-1v-9a1 1 0 011-1z',
      'M5 11l5.5 3.67L16 11',
    ],
    'fotos': [
    ...
    'banking': [
      'M4 10V21M20 10V21M2 10H22M2 10L12 3L22 10M6 21H18',
    ],
    'einstellungen': [
  ...
  /// Baut einen SVG-String mit currentColor, damit `ColorFilter` greift.
  static String svg(String name, {double strokeWidth = 1.75}) {
    final paths = _paths[name] ?? _paths['dashboard']!;
    final pathElements = paths
        .map((d) =>
            '<path stroke-linecap="round" stroke-linejoin="round" d="$d"/>')
        .join();
    return '<svg xmlns="http://www.w3.org/2000/svg" fill="none" '
        'viewBox="0 0 24 24" stroke="currentColor" stroke-width="$strokeWidth">'
        '$pathElements</svg>';
  }
}

/// Widget um ein Heroicon in beliebiger Farbe darzustellen.
class HeroIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SvgPicture.string(
      Heroicons.svg(name, strokeWidth: strokeWidth),
      width: size,
      height: size,
