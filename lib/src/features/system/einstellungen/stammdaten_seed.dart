...
final stammdatenBauelementeExperte = StammdatenProfil(
  ...
  values: {
    ...
    SettingsKeys.nummernkreisAktenzeichenReset: 'nie',
    SettingsKeys.nummernkreisAngebot: 'AN{YYYY}-{NNN}',
    SettingsKeys.nummernkreisAngebotReset: 'nie',
    SettingsKeys.nummernkreisAuftragsbestaetigung: 'AB{YYYY}-{NNN}',
    SettingsKeys.nummernkreisAuftragsbestaetigungReset: 'nie',
    SettingsKeys.nummernkreisRechnung: 'RE{YYYY}-{NNN}',
    SettingsKeys.nummernkreisRechnungReset: 'nie',
    SettingsKeys.nummernkreisAkonto: 'AZ{YYYY}-{NNN}',
    SettingsKeys.nummernkreisAkontoReset: 'nie',
